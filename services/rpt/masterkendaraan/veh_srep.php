...
<th valign="top" width="150"><b>Sales Name<br />Sales Code</b></th>
...
<th valign="top" width="100"><b>Sales Level</b></th>
</tr>
</thead>';
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $tbl .='<td valign="top" width="150">' . $dtlrow['srep_name'] . '<br />' . $dtlrow['srep_code'] . '</td>';
    ...
    $tbl .='<td valign="top" width="100">' . $dtlrow['srep_lev'] . '</td>';
    $tbl .='</tr>';
}
