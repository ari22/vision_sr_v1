...
$tbl .= '
        ...
        <thead style="border:2px solid black !important;">
            ...
            <td valign="top" width="100" align="right"><b>Total</b></td>
...
$tbl .= '<td class="border-foot" valign="top" style="border-bottom:2px solid black;border-top:2px solid black;" align="right"><b>' . number_format($tqty) . '</b></td>';
$tbl .= '<td class="border-foot" valign="top" style="border-right:2px solid black;border-bottom:2px solid black;border-top:2px solid black;" width="100" align="right"><b>' . number_format($tprice) . '</b></td>';
$tbl .= '<td valign="top" width="30"></td>';
$tbl .= '<td valign="top" width="100"></td>';
$tbl .= '<td valign="top" width="150"></td>';
$tbl .= '</tr>';
