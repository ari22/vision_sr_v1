...
<tr><td valign="top" align="center"><b style="font-size:1.1em;">By Sales</b></td></tr>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        if ($i >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top"  colspan="3" align="right"><b>TOTAL SALES ' . $last_srep_code . ':</b></td>';
            ...
            $tbl .='<tr><td></td></tr>';
            $tbl .='<tr>';
            $tbl .='<td valign="top"  colspan="3" align="right"><b>TOTAL ' . $last_wrhs_code . ':</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($item) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($qty) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($price) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($disc) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($price) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($inv_disc) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($inv_bt) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($inv_vat) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($inv_stamp) . '</b></td>';
            $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($inv_total) . '</b></td>';
            $tbl .='<td valign="top" width="30"></td>';
            $tbl .='<td valign="top"></td>';
            $tbl .='</tr>';
        ...
        $tbl.= '<tr><td valign="top" colspan="16" align="left"><b style="font-size:1.1em;">SALES: ' . $dtlrow['srep_code'] . ' : ' . $dtlrow['srep_name'] . '</b></td></tr>';
        $last_srep_code = $dtlrow['srep_code'];
        $last_srep_name = $dtlrow['srep_name'];
    } elseif ($last_srep_code != $dtlrow['srep_code']) {
        if ($j >= 1) {
    ...
    $tbl .='<td valign="top" width="30"></td>';
    $tbl .='<td valign="top" align="left">' . $dtlrow['note'] . '</td>';
    $tbl .='</tr>';
    $i++;
    $j++;
...
if ($i >= 1) {
    $tbl .='<tr>';
    $tbl .='<td valign="top" align="right" colspan="3"><b>TOTAL ' . $last_wrhs_code . ' :</b></td>';
    $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($item) . '</b></td>';
    $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($qty) . '</b></td>';
    $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($price) . '</b></td>';
    $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;"><b>' . number_format($disc) . '</b></td>';
