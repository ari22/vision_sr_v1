...
$tbl .= '
        ...
        <thead style="border:2px solid black !important;">
           <tr>
            ...
            <td valign="top" align="left"><b>Sales</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        if ($i >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top"  colspan="3" align="right"><b>TOTAL CUSTOMER ' . $last_cust_code . ':</b></td>';
        ...
        $tbl.= '<tr><td valign="top" colspan="16" align="left"><b style="font-size:1.1em;">CUSTOMER: ' . $dtlrow['cust_code'] . ' : ' . $dtlrow['cust_name'] . '</b></td></tr>';
        $last_cust_code = $dtlrow['cust_code'];
        $last_cust_name = $dtlrow['cust_name'];
    } elseif ($last_cust_code != $dtlrow['cust_code']) {
        if ($j >= 1) {
    ...
    $tbl .='<td valign="top" align="left">' . $dtlrow['srep_name'] . '</td>';
