...
<tr><td align="center"><b style="font-size:1.1em;">By Invoice No. By Invoice Date</b></td></tr>
...
$tbl .= '
        ...
        <thead style="border:2px solid black !important;">
           <tr>
                ...
                <td width="100" align="left"><b>Warehouse From</b></td>
                <td width="100" align="left"><b>Warehouse To</b></td>
                <td width="5" align="right"><b>Item</b></td>
                <td width="5" align="right"><b>Total<br />Qty</b></td>
                <td width="30"></td>
                <td width="100" align="left"><b>Moved By</b></td>
           </tr>
        </thead>';
$tbl .= '<tr><td></td></tr>';
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $tbl .='<td width="30"></td>';
    $tbl .='<td width="100" align="left">' . $dtlrow['mvrep_code'] . ' : ' . $dtlrow['mvrep_name'] . '</td>';
    $tbl .='</tr>';
