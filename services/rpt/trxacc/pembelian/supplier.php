...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        ...
        if ($i >= 1) {
            ...
            $tbl .='<td valign="top" width="150"></td>';
            $tbl .='<td valign="top" width="150" align="right">TOTAL ' . $last_supp_code . ' :</td>';
            $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">' . number_format($tot_item2) . '</td>';
            $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">' . number_format($tot_qty2) . '</td>';
            ...
            $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">' . number_format($inv_stamp2) . '</td>';
            $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">' . number_format($inv_total2) . '</td>';
            $tbl .='</tr>';
        ...
        $tbl.= '<tr><td valign="top" colspan="7" align="left"><b style="font-size:1.1em;">' . $dtlrow['supp_code'] . ' : ' . $dtlrow['supp_name'] . '</b></td></tr>';
    ...
    $tot_item2 += $dtlrow['tot_item'];
    $tot_qty2 += $dtlrow['tot_qty'];
