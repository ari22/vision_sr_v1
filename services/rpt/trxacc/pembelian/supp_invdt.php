...
<tr><td valign="top" align="center"><b style="font-size:1.1em;">Ivoice Date and Supplier Invoice No</b></td></tr>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        ...
        if ($i >= 1) {
            ...
            $tbl .='<td valign="top" width="150"></td>';
            $tbl .='<td valign="top" width="100" align="right">TOTAL ' . $last_wrhs_code . ' :</td>';
...
$tbl .='<td valign="top" width="200"></td>';
$tbl .='<td valign="top" width="150"></td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right"><b>GRAND TOTAL:</b></td>';
