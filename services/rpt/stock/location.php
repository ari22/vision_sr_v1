...
<tr>
	...
	<td valign="top" width="80px"><b>Color<br>Warehouse</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_loc_code != $dtlrow['loc_code']) {
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
                            <td valign="top" colspan="11" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_loc_code . ':</b></td>
    ...
    $tbl .= '<tr>'
            ...
            . '<td valign="top" width="80px">' . $dtlrow['color_code'] . '<br />' . $dtlrow['wrhs_code'] . '</td>'
