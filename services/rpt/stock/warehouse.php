...
<tr>
	...
	<td valign="top" width="80px"><b>Color<br>Location</b></td>
	<td valign="top" width="100px"><b>Key No.<br>Service Book</b></td>
	<td valign="top" width="80px"><b>Year<br />Supplier</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
                            <td valign="top" colspan="11" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_wrhs_code . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="12" align="left"><b style="font-size:1.1em;">*** WAREHOUSE ' . $dtlrow['wrhs_code'] . ' *** </b></td></tr>';
    ...
    $tbl .= '<tr>'
            ...
            . '<td valign="top" width="80px">' . $dtlrow['color_code'] . '<br />' . $dtlrow['loc_code'] . '</td>'
            . '<td valign="top" width="80px">' . $dtlrow['key_no'] . '<br />' . $dtlrow['serv_book'] . '</td>'
            . '<td valign="top" width="80px"><b>' . $dtlrow['veh_year'] . '</b><br />' . $dtlrow['supp_code'] . '</td>'
