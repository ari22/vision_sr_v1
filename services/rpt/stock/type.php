...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_name != $dtlrow['veh_name']) {
        ...
        if ($j >= 1) {
            $tbl.= '
			<tr>
				<td valign="top" colspan="11" align="right">TOTAL ' . $last_color_code . ' : ' . $last_color_name . ':</td>
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
                            <td valign="top" colspan="11" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_veh_code . ' : ' . $last_veh_name . ':</b></td>
