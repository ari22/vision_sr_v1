...
$statsql = "select b.* from " . $db1 . ".acc_aph a inner join " . $db1 . ".acc_apd b on a.pur_inv_no = b.pur_inv_no  ";
...
$statsql2 = "select a.* from " . $db1 . ".acc_aph a";
