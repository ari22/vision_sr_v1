...
$statsql = "select b.* from " . $db1 . ".veh_arh a inner join " . $db1 . ".veh_ard b on a.sal_inv_no = b.sal_inv_no  ";
...
$statsql2 = "select a.* from " . $db1 . ".veh_arh a";
...
include "view/piutangkendaraan.php";
$filename = 'piutangkendaraan_' . date('d') . '_' . date('m') . '_' . date('Y');
