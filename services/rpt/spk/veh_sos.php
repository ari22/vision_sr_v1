...
<tr>
        ...
        <td class="border-head" valign="top" rowspan="2" align="left" width="180"><b>Supervisor</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_srep_code != $dtlrow['srep_code']) {
        ...
        if ($j >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="8" align="right"><b style="font-size:1.1em;" align="right">TOTAL ' . $last_srep_code . ' : ' . $last_srep_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="17" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['srep_code'] . ' : ' . $dtlrow['srep_name'] . ' ***</b></td></tr>';
    ...
    $tbl.='<td valign="top">' . $dtlrow['sspv_name'] . '</td>';
