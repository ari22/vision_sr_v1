...
<tr>
        <td valign="top" widtd="80px" style="padding-bottom:10px;font-size:0.9em;" align="right"><b>Amount</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        ...
        $tbl.= '<tr><td valign="top" colspan="17" align="left"><b style="font-size:1.1em;">*** WAREHOUSE ' . $dtlrow['wrhs_code'] . ' ***</b></td></tr>';
