...
<tr>
	<td class="border-head" valign="top" rowspan="2" align="center" width="50"><b>SPK Date</b></td>
        ...
        <td class="border-head" valign="top" rowspan="2" align="right" width="20"><b>Qty<br>(unit)</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_code != $dtlrow['veh_code']) {
        ...
        if ($j >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="8" align="right"><b style="font-size:1.1em;" align="right">TOTAL ' . $last_veh_code . ' : ' . $last_veh_name . ':</b></td>
    ...
    $tbl.='<td valign="top">' . $dtlrow['srep_name'] . '<br />' . $dtlrow['sspv_name'] . '<br /></td>';
    $tbl.='<td valign="top">' . $pred_stk_d . '</td>';
    $tbl.='<td valign="top">' . $dtlrow['so_made_by'] . '<br /><br />' . $dtlrow['so_appr_by'] . '</td>';
