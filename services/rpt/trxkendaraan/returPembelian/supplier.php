...
<td valign="top" width="60"><b>Color</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_supp_code != $dtlrow['supp_code']) {
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
                            <td valign="top" colspan="15" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_supp_code . ' : ' . $last_supp_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="15" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['supp_code'] . ': ' . $dtlrow['supp_name'] . ' ***</b></td></tr>';
    ...
    $tbl .='<tr>
            ...
            <td valign="top" width="60">' . $dtlrow['color_code'] . '</td>
