...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_loc_code != $dtlrow['loc_code']) {
        ...
        if ($j >= 1) {
            $tbl.= '
			<tr>
				<td  colspan="12" valign="top" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_loc_code . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="13" align="left"><b style="font-size:1.1em;">*** LOCATION : ' . $dtlrow['loc_code'] . ' *** </b></td></tr>';
	...
	<tr>
		...
		<td valign="top" align="left">' . $dtlrow['loc_code'] . '</td>
