...
<th valign="top" width="100" align="left"><b>Supplier Code</b></th>
<th valign="top" width="100" align="left"><b>Brand</b></th>
<th valign="top" width="120" align="left"><b>Type</b></th>
<th valign="top" width="60" align="left"><b>Year</b></th>
<th valign="top" width="60" align="left"><b>Transmission</b></th>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_name != $dtlrow['veh_name']) {
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
                            <td valign="top" colspan="9" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_veh_code . ' : ' . $last_veh_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="11" align="left"><b style="font-size:1.1em;"> ' . $dtlrow['color_code'] . ': ' . $dtlrow['color_name'] . '</b></td></tr>';
    ...
    $tbl .='<tr>
                <td valign="top" width="60">' . $po_date . '</td>
                <td valign="top" width="100">' . $dtlrow['po_no'] . '</td>
                ...
                <td valign="top" width="80">' . $dtlrow['po_made_by'] . '</td>
                <td valign="top" width="80">' . $dtlrow['po_appr_by'] . '</td>
                <td valign="top" width="50" align="right">' . $dtlrow['qty'] . '</td>
                <td valign="top" width="50" align="right">' . $dtlrow['rcv_qty'] . '</td>
                <td valign="top" width="50" align="right">' . $dtlrow['beg_qty'] . ' UNIT</td>
                <td valign="top" width="90" align="right">' . number_format($dtlrow['unit_price']) . '</td>
            </tr>';
