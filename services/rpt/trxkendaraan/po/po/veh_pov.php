...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_name != $dtlrow['veh_name']) {
        if ($i >= 1) {
			...
			<tr>
				...
				<td  valign="top" align="center" style="border-top:1px solid black;">' . number_format($qty) . '</td>
				<td  valign="top" align="right" style="border-top:1px solid black;">' . number_format($sum_color_value) . '</td>
			</tr>';
            $tbl .='<tr><td></td></tr>';
            $i = 0;
            $qty = 0;
        ...
        if ($j >= 1) {
			...
			<tr>
				...
				<td  valign="top" align="center" style="border-top:1px solid black;"><b>' . number_format($lnQty) . '</b></td>
				<td  valign="top" align="right" style="border-top:1px solid black;"><b>' . number_format($value) . '</b></td>
    ...
    if ($last_color_name != $dtlrow['color_name']) {
        ...
        $tbl.= '
		<tr><td  valign="top" colspan="10"><b style="font-size:1.1em;">' . $dtlrow['color_code'] . ': ' . $dtlrow['color_name'] . '</b></td></tr>';
