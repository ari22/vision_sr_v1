...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_loc_code != $dtlrow['loc_code']) {
        ...
        if ($i >= 1) {
            $tbl.= '
			<tr>
				<td  valign="top" colspan="9" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_loc_code . ':</b></td>
        ...
        $tbl.= '<tr><td  valign="top" colspan="10"><b style="font-size:1.1em;">*** LOCATION : ' . $dtlrow['loc_name'] . ' ***</b></td></tr>';
