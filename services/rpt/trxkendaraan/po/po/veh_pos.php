...
<tr>
	...
	<th class="border-head"  valign="top" align="left" width="100px"><b>Color</b></th>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_supp_code != $dtlrow['supp_code']) {
        ...
        if ($i >= 1) {
            $tbl.= '
			<tr>
				<td  valign="top" colspan="9" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_supp_code . ' : ' . $last_supp_name . ':</b></td>
        ...
        $tbl.= '<tr><td  valign="top" colspan="10"><b style="font-size:1.1em;">*** ' . $dtlrow['supp_code'] . ' : ' . $dtlrow['supp_name'] . ' ***</b></td></tr>';
