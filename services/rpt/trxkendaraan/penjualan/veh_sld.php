...
<tr>
    ...
    <td class="border-head" valign="top" width="100"><b>Color<br />Supervisor</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust_name != $dtlrow['cust_name']) {
        ...
        $tbl.= '<tr><td valign="top" colspan="' . $colCount . '" align="left"><b style="font-size:1.1em;">***  ' . $dtlrow['cust_code'] . ': ' . $dtlrow['cust_name'] . ' ***</b></td></tr>';
    ...
    $tbl .= '<td valign="top">' . $dtlrow['color_name'] . '<br />' . $dtlrow['sspv_name'] . '</td>';
