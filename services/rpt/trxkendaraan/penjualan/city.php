...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust_city != $dtlrow['cust_city']) {
        ...
        if ($i >= 1) {
            $tbl.= '<tr>
			<td valign="top" colspan="8" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_cust_city . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="' . $colCount . '" align="left"><b style="font-size:1.1em;">***  CITY ' . $dtlrow['cust_city'] . ' ***</b></td></tr>';
