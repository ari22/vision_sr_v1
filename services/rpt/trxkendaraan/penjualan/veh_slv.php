...
<tr>
    ...
    <td class="border-head" valign="top" width="40" align="right"><b>Qty<br />(Unit)</b></td>';
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_name != $dtlrow['veh_name']) {
        ...
        if ($i >= 1) {
            $tbl.= '<tr>
			<td valign="top" colspan="8" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_veh_code . ' : '.$last_veh_name.':</b></td>
