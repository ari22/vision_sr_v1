...
<tr>
    ...
    <td class="border-head" valign="top" width="50"><b>Wrhs<br />Loc</b></td>
    <td class="border-head" valign="top" width="100"><b>SPK No.<br />Note</b></td>
    <td class="border-head" valign="top" width="20" align="right"><b>Qty<br />(Unit)</b></td>';
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_color_name != $dtlrow['color_name']) {
        ...
        if ($i >= 1) {
            $tbl.= '<tr>
			<td valign="top" colspan="8" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_color_code . ' : ' . $last_color_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="' . $colCount . '" align="left"><b style="font-size:1.1em;">***  ' . $dtlrow['color_code'] . ': ' . $dtlrow['color_name'] . ' ***</b></td></tr>';
    ...
    $tbl .= '<td valign="top">' . $dtlrow['wrhs_code'] . '<br />' . $dtlrow['loc_code'] . '</td>';
