...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if (empty($dtlrow['lease_code'])) {
     ...
     if ($lnsalpaytype != $lnCash) {
        ...
        if ($i >= 1) {
            $tbl.= '<tr><td valign="top" colspan="8" align="right"><b style="font-size:1.1em;">TOTAL ' . $lcsalpaytype . ':</b></td>';
        ...
        $tbl.= '<tr><td valign="top" colspan="' . $colCount . '" align="left"><b style="font-size:1.1em;">***  ' . $lcsalpaytype2 . ' ***</b></td></tr>';
