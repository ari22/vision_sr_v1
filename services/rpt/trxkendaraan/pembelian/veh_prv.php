...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_name != $dtlrow['veh_name']) {
        if ($j >= 1) {
            $tbl.= '
			<tr>
				<td valign="top"  align="right" colspan="15">TOTAL ' . $last_color_code . ' : ' . $last_color_name . ':</td>
				<td valign="top" align="right" style="border-top:1px solid black;">' . number_format($lnQty2) . '</td>
				<td valign="top" align="right" style="border-top:1px solid black;">' . number_format($value2) . '</td>
			</tr>';
            $j = 0;
            $lnQty2 = 0;
            $value2 = 0;
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top"  align="right" colspan="15"><b style="font-size:1.1em;">TOTAL ' . $last_veh_code . ' : ' . $last_veh_name . ':</b></td>
