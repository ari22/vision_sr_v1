...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_supp_name != $dtlrow['supp_name']) {
        ...
        if ($j >= 1) {
            $tbl.= '
			<tr>
				<td valign="top"  align="right" colspan="15"><b style="font-size:1.1em;">TOTAL ' . $last_supp_code . ' : ' . $last_supp_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="17" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['supp_code'] . ' : ' . $dtlrow['supp_name'] . ' ***</b></td></tr>';
