...
<tr>
    ...
    <td class="border-head" valign="top" width="100"><b>Color</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_from']) {

        if ($j >= 1) {
            $tbl.= '<tr>
			<td valign="top" colspan="15" align="right">TOTAL ' . $last_veh_code . ' : ' . $last_veh_name . ':</td>
        ...
        if ($i >= 1) {
            $tbl.= '<tr>
			<td valign="top" colspan="15" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_wrhs_code . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="16" align="left"><b style="font-size:1.1em;">*** WAREHOUSE FROM ' . $dtlrow['wrhs_from'] . ' ***</b></td></tr>';
        $last_wrhs_code = $dtlrow['wrhs_from'];

        $tbl.= '<tr><td valign="top" colspan="16" align="left"><b style="font-size:1.1em;">' . $dtlrow['veh_code'] . ': ' . $dtlrow['veh_name'] . '</b></td></tr>';
