...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_loc_code != $dtlrow['loc_from']) {
        ...
        if ($i >= 1) {
            $tbl.= '<tr>
			<td valign="top" colspan="15" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_loc_code . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="16" align="left"><b style="font-size:1.1em;">*** LOCATION FROM ' . $dtlrow['loc_from'] . ' ***</b></td></tr>';
        $last_loc_code = $dtlrow['loc_from'];
