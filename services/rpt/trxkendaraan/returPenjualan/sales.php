...
<td valign="top"  width="150"><b>Color</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_srep_code != $dtlrow['srep_code']) {
        ...
        if ($j >= 1) {
            $tbl.= '<tr>
			<td valign="top" colspan="8" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_srep_code . ' : ' . $last_srep_name . ':</b></td>
        ...
        $tbl.= '<tr></tr><tr><td valign="top" colspan="' . $colCount . '" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['srep_code'] . ' : ' . $dtlrow['srep_name'] . ' ***</b></td></tr>';
