...
<td valign="top"  width="50"><b>Color</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_loc_code != $dtlrow['loc_code']) {
        ...
        if ($j >= 1) {
            $tbl.= '<tr>
			<td valign="top" colspan="8" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_loc_code . ':</b></td>
        ...
        $tbl.= '<tr></tr><tr><td valign="top" colspan="' . $colCount . '" align="left"><b style="font-size:1.1em;">*** LOCATION :  ' . $dtlrow['loc_code'] . ' ***</b></td></tr>';
