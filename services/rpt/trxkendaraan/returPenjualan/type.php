...
<td valign="top"  width="160"><b>Customer</b></td>
    ...
    if ($last_veh_name != $dtlrow['veh_name']) {
        ...
        if ($j >= 1) {
            ...
            if ($l_rsal_price == 1) {
                ...
                $tbl.= '<td valign="top" align="right" style="border-top:1px solid black;">' . number_format($veh_vat2) . '</td>';
            }
        ...
        $tbl.= '<tr></tr><tr><td valign="top" colspan="' . $colCount . '" align="left"><b style="font-size:1.1em;">' . $dtlrow['color_code'] . ' : ' . $dtlrow['color_name'] . '</b></td></tr>';
