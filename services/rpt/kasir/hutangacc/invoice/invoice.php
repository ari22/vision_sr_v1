...
<thead style="border:2px solid black !important;" >
    <tr>
        ...
        <td valign="top"  width="70"><b>Invoice<br />Date</b></td>
         <td valign="top" width="100"><b>Supplier</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($pinv_code != $dtlrow['pinv_code']) {
        if ($i >= 1) {

            $tbl .= '<tr>';
            $tbl .= '<td valign="top"  colspan="5" align="right"><b>' . $pinv_code . ':</b></td>';
        ...
        $tbl.= '<tr><td colspan="8" align="left"><b style="font-size:1.1em;">*** Invoice Type ' . $dtlrow['pinv_code'] . ' ***</b></td></tr>';

        $pinv_code = $dtlrow['pinv_code'];
    }
    ...
    $tbl .= '<td valign="top"  align="right">' . number_format($hd_purprice) . '</td>';
