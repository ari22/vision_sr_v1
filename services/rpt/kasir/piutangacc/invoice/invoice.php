...
<thead style="border:2px solid black !important;">
    <tr>
        ...
        <td valign="top"  width="170"><b>Customer<br />Name</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($sinv_code != $dtlrow['sinv_code']) {
        if ($i >= 1) {
            ...
            $tbl .= '<tr>';
            $tbl .= '<td valign="top"  colspan="3" align="right"><b>Total Invoice Type ' . $sinv_code . ':</b></td>';
        ...
        $tbl.= '<tr><td valign="top" colspan="11" align="left"><b style="font-size:1.1em;">*** Invoice Type ' . $dtlrow['sinv_code'] . ' ***</b></td></tr>';
...
$tbl .= '<td class="border-foot" style="border-top:2px solid black;border-bottom:2px solid black;" valign="top"  align="right"></td>';
