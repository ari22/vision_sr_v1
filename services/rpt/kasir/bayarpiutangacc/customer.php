...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust_code != $dtlrow['cust_code']) {
        if ($i >= 1) {
            $tbl .= '<tr>';
            $tbl .= '<td valign="top"  colspan="3" align="right">Total Date : ' . $pay_date . ':</td>';
        ...
        if ($i >= 1) {
            $tbl .= '<tr>';
            $tbl .= '<td valign="top"  colspan="3" align="right"><b>Payment Total ' . $last_cust_code . ':</b></td>';
        ...
        $tbl.= '<tr><td colspan="11" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['cust_code'] . ' : ' . $dtlrow['cust_name'] . ' ***</b></td></tr>';
...
$tbl .= '<td class="border-foot" style="border-top:2px solid black;border-bottom:2px solid black;" valign="top"  align="right"><b>' . number_format($tpay_val) . '</b></td>';
$tbl .= '<td class="border-foot" style="border-right:2px solid black;border-top:2px solid black;border-bottom:2px solid black;" valign="top"  align="right"><b>' . number_format($tdisc_val) . '</b></td>';
$tbl .= '</tr>';
