...
$where =" WHERE LEFT(pur_inv_no,3)='APB' ";
...
if ($_REQUEST['rpt_type']==2)
{
	...
	$title = '(Beginning Balance Update TO Date)';
	if  ($_REQUEST['l_aging']==0)
	{
		$rptFile = "prt_aps1.php"; 
	}else{
...
if (!empty($_REQUEST['aging_sortby'])) {
    $aging = $_REQUEST['aging_sortby'];
...
$where = "where 1=1 " ;
$statsql ="select a.pur_inv_no,a.pur_date,a.chassis,a.engine,a.supp_code,a.supp_name,a.hd_begin,
