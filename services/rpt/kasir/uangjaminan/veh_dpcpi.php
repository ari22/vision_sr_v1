...
<tr>
	...
	<td valign="top" align="left" width="80px"><b>SPK No.<br />SPK Date</b></td>
	<td valign="top" align="left" width="200px"><b>Customer Name</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_srep != $dtlrow['srep_name']) {

        if ($i >= 1) {
            if ($j >= 1) {
                $tbl.= '
				<tr>
					<td valign="top" align="right" colspan="4">TOTAL ' . dateView($last_pay_date) . ' :</td>
            ...
            $tbl.= '
			<tr>
				<td valign="top" align="right" colspan="4"><b style="font-size:1.1em;">TOTAL ' . $last_srep . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="14" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['srep_name'] . ' ***</b></td></tr>';
        $last_srep = $dtlrow['srep_name'];
    }
