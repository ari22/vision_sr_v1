...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust != $dtlrow['cust_name']) {
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" align="right" colspan="4"><b style="font-size:1.1em;">TOTAL ' . $last_cust . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="14" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['cust_name'] . ' ***</b></td></tr>';
        $last_cust = $dtlrow['cust_name'];
    }
