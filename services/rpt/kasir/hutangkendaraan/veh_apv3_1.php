...
<tr>
	<td class="border-head" valign="top" align="center" 	width="100px"><b>Invoice Date<br>Invoice No.</b></td>
	<td class="border-head" valign="top" align="center" 	width="240px"><b>Chassis No.<br>Engine No.</b></td>
...
if ($i >= 1) {
    $tbl.= '
			<tr>
        <td valign="top" colspan="2" align="right"><b style="font-size:1.1em;">Total ' . $last_veh_code . ' : ' . $last_veh_name . ' :</td>
				<td valign="top" align="right" style="border-top:1px solid black;"><b>' . number_format($inv_total) . '</b></td>
				<td valign="top" align="right" style="border-top:1px solid black;"><b>' . number_format($hd_begin) . '</b></td>
				<td valign="top" align="right" style="border-top:1px solid black;"><b>' . number_format($hd_paid) . '</b></td>
				<td valign="top" align="right" style="border-top:1px solid black;"><b>' . number_format($hd_disc) . '</b></td>
...
$tbl.= '<tfoot>
	<tr>    
                <td></td>
		<td class="border-foot" class="border-foot" style="border-left:2px solid black;" valign="top" align="right"><b style="font-size:1.1em;">GRAND TOTAL :</b></td>
		<td class="border-foot" class="border-foot" valign="top" align="right"><b>' . number_format($sum_inv_total) . '</b></td>
		<td class="border-foot" class="border-foot" valign="top" align="right"><b>' . number_format($sum_hd_begin) . '</b></td>
		<td class="border-foot" class="border-foot" valign="top" align="right"><b>' . number_format($sum_hd_paid) . '</b></td>
		<td class="border-foot" class="border-foot" valign="top" align="right"><b>' . number_format($sum_hd_disc) . '</b></td>
		<td class="border-foot" class="border-foot" valign="top" align="right"><b>' . number_format($sum_hd_begin - $sum_hd_paid - $sum_hd_disc) . '</b></td>
		<td class="border-foot" class="border-foot" style="border-right:2px solid black;" valign="top" align="right"><b>Qty : ' . $sumqty . ' Unit</b></td>
	</tr></tfoot>';
