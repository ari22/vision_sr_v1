...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_pinv_code != $dtlrow['pinv_code']) {
        if ($i >= 1) {
            $tbl.= '
			<tr>
        ...
        if ($j >= 1) {
            $tbl.= '
			<tr>
				<td valign="top" colspan="2" align="right"><b style="font-size:1.1em;">Total ' . $last_inv_code . ' :</td>
        ...
        $tbl.= '<tr><td valign="top" colspan="8" align="left"><b style="font-size:1.1em;">Invoice Type ' . $dtlrow['pinv_code'] . '</b> </td></tr>';
        $last_pinv_code = $dtlrow['pinv_code'];
...
if ($j >= 1) {
    $tbl.= '
	<tr>
		<td valign="top" colspan="2" align="right"><b style="font-size:1.1em;">Total ' . $last_pinv_code . ' :</td>
		...
		<td valign="top" align="right" style="border-top:1px solid black;"><b>' . number_format($grp_hd_begin - $grp_hd_paid - $grp_hd_disc) . '</b></td>
	</tr><tr><td valign="top"><br></td></tr>';
...
$tbl.= '<tfoot>
	<tr>    
		...
		<td class="border-foot" style="border-right:2px solid black;" valign="top" align="right"><b>Qty : ' . $sumqty . ' Unit</b></td>
	</tr></tfoot>';
