...
<tr>
	<th valign="top" align="left"><b>Payment Date</b></th>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_sinv_code != $dtlrow['sinv_code']) {
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="5" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_sinv_code . ' : ' . $last_sinv_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="8" align="left"><b style="font-size:1.1em;">*** Invoice Type ' . $dtlrow['sinv_code'] . ' ***</b></td></tr>';
        $last_sinv_code = $dtlrow['sinv_code'];
        $last_pay_date = $dtlrow['pay_date'];
        if ($last_sinv_code == 'VSL') {
            $last_sinv_name = 'SALE';
        } else {
            $last_sinv_name = 'RETUR JUAL';
        }
    }
    if ($last_pay_date != $dtlrow['pay_date']) {
        if ($j >= 1) {
