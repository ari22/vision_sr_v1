...
<tr>
	...
	<td valign="top" align="left" width="70"><b>Payment<br />Type</b></td>
	<td valign="top" align="left" width="70"><b>Check No.</b></td>
...
while($dtlrow=mysql_fetch_array($dtl)){
	...
	if ($last_pay_type != $dtlrow['pay_type'])
	{
        if ($j>=1)
        {
            $tbl.= '
			<tr></tr><tr>
				<td valign="top" align="right" colspan="4"><b>TOTAL '.dateView($last_pay_date).' :</b></td>
            ...
            $lnQty = 0;  $grp_pay_val = 0; $grp_disc_val = 0;
        }
		if ($i>=1)
		{
			$tbl.= '
			<tr>
				<td valign="top" colspan="4" align="right"><b style="font-size:1.1em;">TOTAL '.$last_pay_type.':</b></td>
			...
			$lnQty = 0;  $pay_val = 0; $disc_val = 0;$j=0;
		}
		$tbl.= '<tr><td valign="top" colspan="8" align="left" style="font-size:1.1em;"><b>*** Payment Type '.$dtlrow['pay_type'].' ***</b></td></tr>';
	...
	if ($last_pay_date != $dtlrow['pay_date'])
	{
		...
		$tbl.= '
			<tr></tr><tr>
				<td valign="top" align="right" colspan="4"><b>TOTAL '.dateView($last_pay_date).' :</td>
				<td valign="top" align="right" style="border-top:1px solid black;"><b>'.number_format($grp_pay_val).'</b></td>
				<td valign="top" align="right" style="border-top:1px solid black;"><b>'.number_format($grp_disc_val).'</b></td>
	...
	<tr>
		...
		<td valign="top" align="left">'.$dtlrow['pur_date'].'</td>
