...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_lease_code != $dtlrow['lease_code']) {
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="3" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_lease_code . ' : ' . $last_lease_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="9" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['lease_code'] . ' : ' . $dtlrow['lease_name'] . ' ***</b></td></tr>';
...
$tbl.= '
	<tr>    
		...
		<td style="border-top:2px solid black;" valign="top" align="right"><b>' . number_format($lease_pd_begin) . '</b></td>
                <td style="border-top:2px solid black;" valign="top" align="right"><b>' . number_format($lease_pd_sales) . '</b></td>
		...
		<td style="border-right:2px solid black;border-top:2px solid black;" valign="top" align="right"><b>' . number_format($lease_pd_end) . '</b></td>
		<td valign="top" align="right"></td>
	</tr>';
$tbl.= '
	<tr>    
		...
		<td valign="top" align="right"><b>' . number_format($nonlease_pd_begin) . '</b></td>
                <td valign="top" align="right"><b>' . number_format($nonlease_pd_sales) . '</b></td>
		...
		<td style="border-right:2px solid black;" valign="top" align="right"><b>' . number_format($nonlease_pd_end) . '</b></td>
		<td valign="top" align="right"></td>
	</tr>';
$tbl.= '
	<tr>    
		...
		<td style="border-bottom:2px solid black;" valign="top" align="right"><b>' . number_format($sum_pd_begin) . '</b></td>
                <td style="border-bottom:2px solid black;" valign="top" align="right"><b>' . number_format($sum_pd_sales) . '</b></td>
		...
		<td style="border-right:2px solid black;border-bottom:2px solid black;" valign="top" align="right"><b>' . number_format($sum_pd_end) . '</b></td>
		<td valign="top" align="right"></td>
	</tr>';
$tbl .='
</table>
