...
<tr>
	...
	<td valign="top" align="left" width="200px" 	><b>Chassis No.<br>Engine No.</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust_code != $dtlrow['cust_code']) {
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="2" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_cust_code . ' : ' . $last_cust_name . ':</b></td>
				<td valign="top" align="right" style="border-top:1px solid black;"><b>' . number_format($inv_total) . '</b></td>
				<td valign="top" align="right" style="border-top:1px solid black;"><b>' . number_format($pd_begin) . '<br />' . number_format($veh_total) . '</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="13" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['cust_code'] . ' : ' . $dtlrow['cust_name'] . ' ***</b></td></tr>';
    ...
    $sum_veh_total += $dtlrow['veh_total'];
...
$tbl.= '<tr><td valign="top"></td></tr>
		...
		<td class="border-foot" style="border-top:2px solid black;border-bottom:2px solid black;" valign="top" align="right"><b>' . number_format($sum_pd_begin) . '<br />' . number_format($sum_veh_total) . '</b></td>
