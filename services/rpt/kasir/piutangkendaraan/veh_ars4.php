...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_srep_code != $dtlrow['srep_code']) {
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="2" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_srep_code . ' : ' . $last_srep_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="13" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['srep_code'] . ' : ' . $dtlrow['srep_name'] . ' ***</b></td></tr>';
