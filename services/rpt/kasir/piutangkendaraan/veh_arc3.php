...
<tr>
	...
	<td valign="top" width="140px" align="left"><b>Chassis No.<br>Engine No.</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust_code != $dtlrow['cust_code']) {
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="3" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_cust_code . ' : ' . $last_cust_name . ':</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="9" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['cust_code'] . ' : ' . $dtlrow['cust_name'] . ' ***</b></td></tr>';
