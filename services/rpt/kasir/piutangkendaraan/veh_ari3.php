...
<tr>
	<td valign="top" width="120px" align="left"><b>Invoice Date<br>Invoice No.</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_sinv_code != $dtlrow['sinv_code']) {
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="3" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_sinv_code . ' :</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="9" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['sinv_code'] . '  ***</b></td></tr>';
