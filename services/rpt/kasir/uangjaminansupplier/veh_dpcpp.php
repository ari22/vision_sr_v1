...
//buang kolom customer name
//tambah kolom collector code
...
<tr>
	<td valign="top" align="left" width="70px"><b>Payment Date</b></td>
	...
	<td valign="top" align="left" width="170px"><b>Customer Name</b></td>
	...
	<td valign="top" align="left" width="150px"><b>Note</b></td>
        <td valign="top" align="left" width="70px"><b>Collector Code</b></td>
</tr></thead>
';
...
while($dtlrow=mysql_fetch_array($dtl)){
	...
	if ($last_cust != $dtlrow['supp_name'])
	{
		...
		if ($i>=1)
		{
			if ($j>=1)
			{
				...
				<tr>
					...
					<td valign="top"></td>
					<td valign="top"></td>
				</tr><tr><td valign="top" colspan="5"></td><td valign="top" colspan="4" style="border-bottom:2px solid black"><br></td></tr>';
				$j=0;$date_unit_price = 0;$date_pay_val = 0;$date_used_val = 0;$date_cancel_val = 0;
			}
			$tbl.= '
			<tr>
				<td valign="top" colspan="3"></td>
				<td valign="top" align="right" colspan="2"><b style="font-size:1.1em;">TOTAL '.$last_cust.':</b></td>
		...
		$tbl.= '<tr><td valign="top" colspan="14" align="left"><b style="font-size:1.1em;">*** '.$dtlrow['supp_name'].' ***</b></td></tr>';
		$last_cust = $dtlrow['supp_name'];
	...
	if ($last_pay_date != $dtlrow['pay_date'])
	{
		...
		$tbl.= '<tr><td valign="top" colspan="14" align="left"><b style="font-size:1.1em;">Date '.dateView($dtlrow['pay_date']).'</b></td></tr>';
	...
	if (substr($dtlrow['pur_inv_no'],0,3)=='PRH')
	{
	...
	$tbl .= '
		...
		<td valign="top" align="left">'.$dtlrow['pay_desc'].'</td>
                <td valign="top" align="left">'.$dtlrow['coll_code'].'</td>
	</tr>';
	$i++;
	$j++;
	unset($dtlrow);
...
<tr height="30px">
                            <td colspan="4"></td>
				<td class="border-foot" valign="top" align="right" style="border-left:2px solid black;border-top:2px solid black;border-bottom:2px solid black;" ><b style="font-size:1.1em;">GRAND TOTAL :</b></td>
