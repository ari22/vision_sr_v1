...
<tr>
	...
	<td valign="top" align="left" width="170px"><b>Supplier Name</b></td>
...
while($dtlrow=mysql_fetch_array($dtl)){
	...
	if ($last_pay_type != $dtlrow['pay_type'])
	{
		...
		if ($i>=1)
		{
			if ($j>=1)
			{
				...
				</tr><tr><td valign="top" colspan="5"></td><td valign="top" colspan="3" style="border-bottom:2px solid black"><br></td></tr>';
		...
		$tbl.= '<tr><td valign="top" colspan="14" align="left"><b style="font-size:1.1em;">*** '.$dtlrow['pay_type'].' ***</b></td></tr>';
	...
	<tr>
		...
		<td valign="top" align="left">'.$dtlrow['pur_inv_no'].'<br>'.$pur_date.'</td>
