...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wk_code != $dtlrow['wk_code']) {
        if ($i >= 1) {
...
if ($i >= 1) {
    ...
    $tbl .='<td valign="top"></td>';
    $tbl .='<td valign="top" ></td>';
    $tbl .='<td valign="top" align="right"  colspan="2"><b>TOTAL ' . $last_wk_code . ' : '.$last_wk_desc.' :</b></td>';
    $tbl .='<td valign="top" align="right" style="border-top:1px solid #000;">' . number_format($price_bd) . '</td>';
    $tbl .='</tr>';
...
$tbl .='<td class="border-foot" valign="top" style="border-right:2px solid black;border-top:2px solid black;border-bottom:2px solid black;" align="right"><b>' . number_format($t_price_bd) . '</b></td>';
$tbl .='</tr>';
$tbl .='</tfoot>';
$tbl .= '</table>';
