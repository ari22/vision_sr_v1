...
$tbl .= '<thead style="border:2px solid black !important;">
            <tr>
                ...
                <th align="left"><b>Work Name</b></th>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wk_desc != $dtlrow['wk_desc']) {
        if ($i >= 1) {
            ...
            $tbl .='<td></td>';
            $tbl .='<td></td>';
            $tbl .='<td align="right"><b>TOTAL ' . $last_wk_code . ' :</b></td>';
...
$tbl .='<td class="border-foot" style="border-right:2px solid black;border-top:2px solid black;border-bottom:2px solid black;" align="right">' . number_format($t_price_bd) . '</td>';
$tbl .='</tr>';
$tbl .='</tfoot>';
$tbl .= '</table>';
