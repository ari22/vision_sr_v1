...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_code != $dtlrow['veh_code']) {
        ...
        if ($j >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="12" align="right">' . $last_color_code . ' : '.$last_color_name.' :</td>';
        ...
        if ($i >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="12" align="right"><b>' . $last_veh_code . ' : '.$last_veh_name.' :</b></td>';
