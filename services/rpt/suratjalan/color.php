...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_color_code != $dtlrow['color_code']) {
        ...
        if ($i >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="12" align="right">' . $last_veh_code . ' : '.$last_veh_name.' :</td>';
            $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;" align="right">' . $qty . '</td>';
            $tbl .='</tr>';
            $i = 0;
        }
        ...
        if ($j >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="12" align="right"><b>' . $last_color_code . ' : '.$last_color_name.' :</b></td>';
