...
<tr><td valign="top" align="center"><b style="font-size:1.1em;">By Sales Name & Customer Name</b></td></tr>
...
$tbl .= '<thead style="border:2px solid black !important;">
            <tr>
                ...
                <td valign="top" width="150"><b>Sales<br />Customer Name</b></td>
                ...
                <td valign="top" width="120"><b>Insurance<br />Leasing</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $tbl .= '<td valign="top" width="150">' . $dtlrow['srep_code'] . ' : ' . $dtlrow['srep_name'] . '<br />'. $dtlrow['cust_name'] . '</td>';
    $tbl .= '<td valign="top" width="100">' . $dtlrow['so_no'] . '<br />' . $so_date . '</td>';
    ...
    $tbl .= '<td valign="top" width="120">' . $dtlrow['crdinscode'] . '<br />' . $dtlrow['lease_code'] . '</td>';
