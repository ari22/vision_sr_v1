...
<tr><td valign="top" align="center"><b style="font-size:1.1em;">By Customer Name & Leasing Code</b></td></tr>
...
$tbl .= '<thead style="border:2px solid black !important;">
            <tr>
                ...
                <td valign="top" width="150" align="left"><b>Customer Name<br />Leasing</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $tbl .= '<td valign="top" width="150" align="left"><b>' . $dtlrow['cust_name'] . '</b><br />' . $leasing . '</td>';
    $tbl .= '<td valign="top" width="100" align="left">' . $dtlrow['so_no'] . '<br />' . $so_date . '</td>';
    ...
    $tbl .= '<td valign="top" width="30" align="left"></td>';
