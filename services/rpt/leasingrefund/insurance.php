...
<tr><td valign="top" align="center"><b style="font-size:1.1em;">By Insurance Name & Leasing Code</b></td></tr>
...
$tbl .= '<thead style="border:2px solid black !important;">
            <tr>
                ...
                <td valign="top" width="150"><b>Insurance Code & Name<br />Customer Name</b></td>
                <td valign="top" width="100"><b>SPK No.<br />SPK Date</b></td>
                <td valign="top" width="80"><b>Model<br />Type</b></td>
                <td valign="top" width="100"><b>Chassis<br />Engine</b></td>
                ...
                <td valign="top" width="120"><b>Leasing<br />Sales</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $ins = '-';
    if($dtlrow['crdinscode'] !== ''){
        $ins = $dtlrow['crdinscode'] . ' : ' . $dtlrow['crdinsname'];
    }
    
    $tbl .= '<tr>';
    $tbl .= '<td valign="top" width="30">' . $no++ . '.</td>';
    $tbl .= '<td valign="top" width="150">' . $ins . '<br />'. $dtlrow['cust_name'] . '</td>';
    $tbl .= '<td valign="top" width="100"><b>' . $dtlrow['so_no'] . '</b><br />' . $so_date . '</td>';
    $tbl .= '<td valign="top" width="80">' . $dtlrow['veh_model'] . '<br />' . $dtlrow['veh_type'] . '</td>';
    $tbl .= '<td valign="top" width="100">' . $dtlrow['chassis'] . '<br />' . $dtlrow['engine'] . '</td>';
    ...
    $tbl .= '<td valign="top" width="120">' . $dtlrow['lease_code'] . '<br />' . $dtlrow['srep_name'] . '</td>';
