...
<tr><td valign="top" align="center"><b style="font-size:1.1em;">By Chassis & Vehicle Model</b></td></tr>
...
$tbl .= '<thead style="border:2px solid black !important;">
            <tr>
                ...
                <td valign="top" width="100"><b>Model<br />Type</b></td>
                <td valign="top" width="150"><b>Customer Name<br />SPK No.</b></td>
                <td valign="top" width="100"><b>SPK Date</b></td>
                <td valign="top" width="150"><b>Year<br />Color</b></td>
                <td valign="top" width="100" align="right"><b>Credit Term<br />(month(s))</b></td>
                <td valign="top" width="100" align="right"><b>Installment<br />(/Month)</b></td>
                <td valign="top" width="100" align="right"><b>Interest<br />(/Year)</b></td>
                <td valign="top" width="150"><b>Insurance<br />Leasing</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        if ($i >= 1) {
            $tbl .= '<tr>';
            $tbl .= '<td valign="top" colspan="10" align="right"><b>TOTAL ' . $last_wrhs_code . ' :</b></td>';
            $tbl .= '<td valign="top" width="100" align="right" style="border-top:1px solid black;">' . number_format($crdinscomm) . '</td>';
            $tbl .= '<td valign="top" width="100" align="right" style="border-top:1px solid black;">' . number_format($crdinsdisc) . '</td>';
    ...
    $tbl .= '<td valign="top" width="130">' . $dtlrow['chassis'] . '<br />' . $dtlrow['engine'] . '</td>';
    $tbl .= '<td valign="top" width="100">' . $dtlrow['veh_model'] . '<br />' . $dtlrow['veh_type'] . '</td>';
    $tbl .= '<td valign="top" width="150">' . $dtlrow['cust_name'] . '<br />' . $dtlrow['so_no'] . '</td>';
    $tbl .= '<td valign="top" width="100">' . $so_date . '</td>';
    $tbl .= '<td valign="top" width="150">' . $dtlrow['veh_year'] . '<br />' . $dtlrow['color_name'] . '</td>';
    $tbl .= '<td valign="top" width="100" align="right">' . number_format($dtlrow['crd_term']) . '</td>';
    $tbl .= '<td valign="top" width="100" align="right">' . number_format($dtlrow['crd_mthpay']) . '</td>';
    $tbl .= '<td valign="top" width="100" align="right">' . $dtlrow['crd_irate'] . '</td>';
    $tbl .= '<td valign="top" width="150">' . $dtlrow['crdinscode'] . '<br />' . $dtlrow['lease_code'] . '</td>';
    $tbl .= '<td valign="top" width="100" align="right">' . number_format($dtlrow['crdinscomm']) . '</td>';
    $tbl .= '<td valign="top" width="100" align="right">' . number_format($dtlrow['crdinsdisc']) . '</td>';
    ...
    $tbl .= '<td valign="top" width="150">' . $dtlrow['srep_name'] . '</td>';
    $tbl .= '</tr>';
