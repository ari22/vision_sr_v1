...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        ...
        if ($j >= 1) {
            $tbl.= '
			<tr>
				<td valign="top" colspan="13" align="right">TOTAL ' . $last_veh_code . ' : ' . $last_veh_name . ':</td>
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
                            <td valign="top" colspan="13" align="right"><b style="font-size:1.1em;">TOTAL ' . $last_wrhs_code . ' :</b></td>
        ...
        $tbl.= '<tr><td valign="top" colspan="13" align="left"><b style="font-size:1.1em;">*** ' . $dtlrow['wrhs_code'] . '  ***</b></td></tr>';
