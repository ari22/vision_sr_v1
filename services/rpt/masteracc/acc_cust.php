...
<td valign="top" width="200" align="left"><b>Mailing Address</b></td>
<td valign="top" width="150" align="left"><b>Phone/Fax/HP/Email</b></td>
<td valign="top" width="100" align="left"><b>Contact Person/<br />Job Position </b></td>
<td valign="top" width="100" align="left"><b>Gender</b></td>
<td valign="top" width="100" align="left"><b>NPWP</b></td>
</tr>
</thead>';
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $tbl .='<td valign="top" width="100" align="left">' . $dtlrow['cust_code'] . '</td>';
    $tbl .='<td valign="top" width="150" align="left">' . $dtlrow['cust_name'] . '</td>';
    $tbl .='<td valign="top" width="200" align="left">' . $addr . '</td>';
    $tbl .='<td valign="top" width="150" align="left">' . $phone . '/' . $fax . '/' . '/' . $hp . '/' . $email . '</td>';
    $tbl .='<td valign="top" width="100" align="left">' . $dtlrow['ocp1_title'] . '/' . $dtlrow['ocp1_name'] . '</td>';
    $tbl .='<td valign="top" width="100" align="left">' . $sex . '</td>';
    $tbl .='<td valign="top" width="100" align="left">' . $dtlrow['onpwp'] . '</td>';
    $tbl .='</tr>';
}
