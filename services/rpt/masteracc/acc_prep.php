...
<td valign='top' width='150' align='left'><b>Purchaser  Name<br />Purchaser Code</b></td>
...
<td valign='top' width='100' align='left'><b>Purchaser Level</b></td>
</tr>
</thead>";
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $tbl .='<td valign="top" width="150" align="left">' . $dtlrow['prep_name'] . '<br />' . $dtlrow['prep_code'] . '</td>';
    ...
    $tbl .='<td valign="top" width="100" align="left">' . $dtlrow['prep_lev'] . '</td>';
    $tbl .='</tr>';
}
