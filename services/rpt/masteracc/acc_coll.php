...
<td valign='top' width='150' align='left'><b>Collector's  Name<br />Collector's Code</b></td>
...
<td valign='top' width='100' align='left'><b>Collector's Level</b></td>
</tr>
</thead>";
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $tbl .='<td valign="top" width="150" align="left">' . $dtlrow['coll_name'] . '<br />' . $dtlrow['coll_code'] . '</td>';
    ...
    $tbl .='<td valign="top" width="100" align="left">' . $dtlrow['coll_lev'] . '</td>';
    $tbl .='</tr>';
}
