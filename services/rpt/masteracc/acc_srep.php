...
<td valign="top" width="150" align="left"><b>Sales Name<br />Sales Code</b></td>
...
<td valign="top" width="100" align="left"><b>Sales Level</b></td>
</tr>
</thead>';
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    $tbl .='<td valign="top" width="150" align="left">' . $dtlrow['srep_name'] . '<br />' . $dtlrow['srep_code'] . '</td>';
    ...
    $tbl .='<td valign="top" width="100" align="left">' . $dtlrow['srep_lev'] . '</td>';
    $tbl .='</tr>';
}
