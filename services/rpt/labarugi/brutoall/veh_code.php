...
<tr><td valign="top" align="center"><b style="font-size:1.1em;">By Vehicle Code</b></td></tr>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_code != $dtlrow['veh_code']) {
        if ($j >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="5" align="right">Total Gross Profit and Loss from Wrhs ' . $last_wrhs_code . '</td>';
            ...
            $tbl .='<td valign="top" width="76" align="right" style="border-top:1px solid #000;" align="right">' . number_format($labarugibbn2) . '</td>';
        ...
        if ($i >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="5"  align="right"><b>Total Gross Profit and Loss ' . $last_veh_code . ' :</b></td>';
            ...
            $tbl .='<td valign="top" width="76" align="right" style="border-top:1px solid #000;" align="right">' . number_format($labarugibbn) . '</td>';
...
/*
  ...
  <td valign="top" colspan="5" align="right" style="color:blue;"><b>TOTAL GROSS INCOME PENJUALAN :</b></td>
...
$tbl .= '<tr>
                ...
                <td class="border-foot" style="border-bottom:2px solid black;border-top:2px solid black;" valign="top" width="100" align="right"><b>' . number_format($tlabarugibbn) . '</td>
