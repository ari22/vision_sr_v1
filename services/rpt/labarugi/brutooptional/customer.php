...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust_code != $dtlrow['cust_code']) {
        ...
        $tbl.= '<tr><td valign="top" colspan="13" align="left"><b style="font-size:1.1em;">***PELANGGAN : ' . $dtlrow['cust_code'] . ' : '.$dtlrow['cust_name'] . '***</b></td></tr>';
...
$tbl .= '<td class="border-foot" valign="top" width="100" align="right"><b>' . number_format($pur_misc) . '</b></td>';
