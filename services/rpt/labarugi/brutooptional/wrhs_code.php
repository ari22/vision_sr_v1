...
$tbl .= '<thead style="border:2px solid black !important;">
            <tr>
                ...
                <td valign="top" width="100" align="right"><b>DPP</b></td>
                <td valign="top" width="100" align="right"><b>Etc.</b></td>
                <td valign="top" width="115" align="right"><b>Total<br />Purchase Price</b></td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_wrhs_code != $dtlrow['wrhs_code']) {
        if ($j >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="2" align="right"><b>Total Gross Income From Wrhs ' . $last_wrhs_code . '</b></td>';
...
$tbl .='<td valign="top" colspan="2" align="right" style="color:blue;"><b>TOTAL GROSS INCOME SALE :</b></td>';
