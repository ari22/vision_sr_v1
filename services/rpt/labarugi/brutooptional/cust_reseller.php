...
//diperbaiki biar klo 1 dealer lbh dr 1 tipe kendaraan ga error
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust_code != $dtlrow['cust_code']) {
        if ($i >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="2" align="right">Total Gross Income ' . $last_veh_code . ' :</td>';
        ...
        if ($j >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="2" align="right"><b>Total Gross Income By Customer ' . $last_cust_code . '</b></td>';
         ...
         $tbl.= '<tr><td valign="top" colspan="13" align="left"><b style="font-size:1.1em;">***CUSTOMER : ' . $dtlrow['cust_code'] . ' : '.$dtlrow['cust_name'] . '***</b></td></tr>';
    ...
    $dpp1 += $dtlrow['price_bd'] - $dtlrow['disc_val'];


    $labarugi1 += $dtlrow['srv_at'] - $dtlrow['price_ad'];
...
$tbl .='<td valign="top" colspan="2" align="right" style="color:blue;"><b>TOTAL SALES GROSS INCOME :</b></td>';
...
$tbl .='<td valign="top" colspan="2" align="right"><b>TOTAL GROSS INCOME :</b></td>';
