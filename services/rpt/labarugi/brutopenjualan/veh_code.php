...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_veh_code != $dtlrow['veh_code']) {
        if ($j >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="2" valign="top">Total Gross Profit and Loss from Wrhs ' . $last_wrhs_code . ' :</td>';
            ...
            $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">' . number_format($qty1) . ' Unit</td>';
            $tbl .='</tr>';
        ...
        if ($i >= 1) {
            ...
            $tbl .='<td valign="top" width="100" align="right" style="border-top:2px solid #000;">' . number_format($qty) . ' <b>UNIT</b></td>';
            $tbl .='</tr>';
...
while ($dtlrow2 = mysql_fetch_array($dtl2)) {
    ...
    if ($last_veh_code2 != $dtlrow2['veh_code']) {
        ...
        if ($j2 >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="2" valign="top">Total Gross Profit and Loss from Wrhs ' . $last_wrhs_code2 . ' :</td>';
