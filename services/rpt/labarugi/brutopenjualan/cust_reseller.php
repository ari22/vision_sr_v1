...
<tr><td valign="top" align="center"><b style="font-size:1.1em;">By Dealer/Reseller</b></td></tr>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    ...
    if ($last_cust_code != $dtlrow['cust_code']) {
        if ($j >= 1) {
            $tbl .='<tr>';
            $tbl .='<td valign="top" colspan="2" valign="top"><b>Total Gross Profit and Loss from Dealer ' . $last_cust_code . ' :</b></td>';
        ...
        $tbl.= '<tr><td valign="top" colspan="11" align="left"><b style="font-size:1.1em;">***DEALER : ' . $dtlrow['cust_code'] . ' : ' . $dtlrow['cust_name'] . '***</b></td></tr>';
...
if ($countreturn > 0) {
    ...
    while ($dtlrow2 = mysql_fetch_array($dtl2)) {
        ...
        if ($last_cust_code2 != $dtlrow2['cust_code']) {
            if ($j2 >= 1) {
                $tbl .='<tr>';
                $tbl .='<td valign="top" colspan="2" valign="top">Total Gross Profit and Loss from Wrhs ' . $last_cust_code2 . ' :</td>';
            ...
            $tbl.= '<tr><td valign="top" colspan="11" align="left"><b style="font-size:1.1em;">***DEALER : ' . $dtlrow2['cust_code'] . ' : ' . $dtlrow2['cust_name'] . '***</b></td></tr>';
            $last_cust_code2 = $dtlrow2['cust_code'];
            $last_cust_name2 = $dtlrow2['cust_name'];
        }
    ...
    if ($j2 >= 1) {
        $tbl .='<tr>';
        $tbl .='<td valign="top" colspan="2" valign="top">Total Gross Profit and Loss from Dealer ' . $last_cust_code2 . ' :</td>';
        $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">-' . number_format($veh_price22) . '<br />-' . number_format($veh_bbn22) . '</td>';
        $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">-' . number_format($veh_disc22) . '<br />-' . number_format($veh_misc22) . '</td>';
        $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">-' . number_format($veh_at22) . '<br />-' . number_format($veh_total22) . '</td>';
        $tbl .='<td valign="top" width="100" align="right" style="border-top:1px solid #000;">-' . number_format($veh_vat22) . '<br />-' . number_format($veh_pbm22) . '</td>';
...
$tbl .='<td class="border-foot" valign="top" colspan="2" valign="top" align="right"><b>TOTAL Profit and Loss Bruto:</b></td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tveh_price - $tveh_price2) . '<br />' . number_format($tveh_bbn - $tveh_bbn2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tveh_disc - $tveh_disc2) . '<br />' . number_format($tveh_misc - $tveh_misc2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tveh_at - $tveh_at2) . '<br />' . number_format($tveh_total - $tveh_total2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tveh_vat - $tveh_vat2) . '<br />' . number_format($tveh_pbm - $tveh_pbm2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tveh_bt - $tveh_bt2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tpur_price - $tpur_price2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tpur_misc - $tpur_misc2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tpur_vat - $tpur_vat2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tpur_bt - $tpur_bt2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tlaba - $tlaba2) . '</td>';
$tbl .='<td class="border-foot" valign="top" width="100" align="right">' . number_format($tqty - $tqty2) . ' Unit</td>';
$tbl .='</tr>';
$tbl .= '</table>';
