...
$statsql = "SELECT a.* FROM " . $db1 . ".vehspkch a";
$where = " WHERE 1=1 AND a.canc_date>='" . $so_date1 . "' AND a.canc_date<='" . $so_date2 . "'";
...
include"batalspk/" . $rptFile;

$filename = 'batalspk_' . date('dmy') . '_' . date('his');
