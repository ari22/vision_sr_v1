...
<tr>
    ...
    <td class="border-head" valign="top" >Wrhs</td>
...
while ($dtlrow = mysql_fetch_array($dtl)) {
    if ($last_color_code != $dtlrow['color_code']) {
        ...
        if ($i >= 1) {
            ...
            $tbl.= '
			<tr>
				<td valign="top" colspan="9" align="right"><b style="font-size:1.1em;" align="right">TOTAL ' . $last_color_code . ' : ' . $last_color_name . ':</b></td>
