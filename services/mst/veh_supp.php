...
if (isset($func))
{
	...
	{		
		if (isset($field1) && isset($field2))
		{
			...
			$result=mysql_query($sql);
			$row=mysql_fetch_array($result);
			$query_update="update $table set $field1='".strtoupper($$field1)."', $field2='".strtoupper($$field2)."' where id='".$row['id']."'";
	...
	if ($func=='update')
	{
		...
		if (isset($field1) && isset($field2))
		{
			...
			}else
			{
				...
				$query_update="update $table set $field2='".strtoupper($$field2)."',supp_alias='$supp_alias',sex='$sex',postaddr='$postaddr',oaddr='$oaddr',oarea='$oarea',ocity='$ocity',ozipcode='$ozipcode',ocountry='$ocountry',ophone='$ophone',ofax='$ofax',oemail='$oemail',ocp1_name='$ocp1_name',ocp1_title='$ocp1_title',ocp2_name='$ocp2_name',ocp2_title='$ocp2_title',bus_fld='$bus_fld',bus_item='$bus_item',onpwp='$onpwp',opkp='$opkp',oest_date='$oest_date',ovat='$ovat' where id=$id";
				$result = mysql_query($query_update);
