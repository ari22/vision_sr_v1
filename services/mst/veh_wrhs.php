...
if (isset($func)) {
    if ($func == 'reccount') {
        ...
        switch ($wrhs_axs) {
            ...
            default:
                $result = "select * from $table where 1=1 and wrhs_code='$wrhs_axs' ";
                break;
        }
    ...
    if ($func == 'read') {
        ...
        switch ($wrhs_axs) {
            ...
            default:
                $result = "select $defaultfields from $table where 1=1 and wrhs_code='$wrhs_axs' ";
                break;
        }
        ...
        switch ($wrhs_axs) {
            ...
            default:
                $sql = "select count($field1) as n_count from ($result) a where 1=1 and wrhs_code='$wrhs_axs' ";
                break;
        }
        if (isset($page)) {
            $start = ($rows * ($page - 1));
    ...
    if ($func == 'create') {
        if (isset($field1) && isset($field2)) {
            ...
            if ($count >> 0) {
                ...
                $query = "select id from $table where $field2 = '" . $$field2 . "'";
    ...
    if ($func == 'update') {
        ...
        if (isset($field1) && isset($field2)) {
            ...
            if ($count == 0) {
                ...
                $sql = "update $table set $field2='" . strtoupper($$field2) . "' where id=$id";
                $result = mysql_query($sql);
    ...
    if ($func == 'datasource') {
        ...
        switch ($wrhs_axs) {
            ...
            default:
                $sql = "select count(*) as n_count from ($result) a where 1=1 and wrhs_code='$wrhs_axs' ";
                break;
        }
