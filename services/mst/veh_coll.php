	...
	if ($func=='update')
	{
		...
		if (isset($field1) && isset($field2))
		{
			...
			}else
			{
				...
				//mau dicoba versi sendiri
				$query_update="update $table set $field2='".strtoupper($$field2)."',sex='$sex',coll_lev='$coll_lev',in_date='$in_date',out_date='$out_date',dob='$dob',pob='$pob',marital_st='$marital_st',haddr='$haddr',hphone='$hphone',hcity='$hcity',hzipcode='$hzipcode',hp='$hp',highestedu='$highestedu',train_exp='$train_exp',relig_code='$relig_code',note='$note' where id=$id";
