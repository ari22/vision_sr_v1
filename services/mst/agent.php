...
if (isset($func))
{
	...
	if ($func=='update')
	{
		...
		if (isset($field1) && isset($field2))
		{
			...
			{
				//mau dicoba versi sendiri
				$query_update="update $table set $field2='".strtoupper($$field2)."',oaddr='$oaddr',oarea='$oarea',ophone='$ophone',ocity='$ocity',ozipcode='$ozipcode',ocountry='$ocountry',ohp='$ohp',ofax='$ofax',note='$note',oemail='$oemail',ocp1_name='$ocp1_name',ocp1_title='$ocp1_title',ocp2_name='$ocp2_name',ocp2_title='$ocp2_title' where id=$id";
