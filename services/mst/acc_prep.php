	...
	if ($func=='update')
	{
		...
		if (isset($field1) && isset($field2))
		{
			...
			{	
				...
				//mau dicoba versi sendiri
				$query_update="update $table set $field2='".strtoupper($$field2)."',haddr='$haddr',hphone='$hphone',hcity='$hcity',hzipcode='$hzipcode',hp='$hp',highestedu='$highestedu',train_exp='$train_exp',note='$note',sex='$sex',prep_lev='$prep_lev',in_date='$in_date',out_date='$out_date',dob='$dob',pob='$pob',relig_code='$relig_code' where id=$id";
