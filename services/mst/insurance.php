	...
	if ($func=='update')
	{
		...
		if (isset($field1) && isset($field2))
		{
			...
			}else
			{
				...
				//mau dicoba versi sendiri
				$query_update="update $table set $field2='".strtoupper($$field2).", insr_alias='$insr_alias',sex='$sex',postaddr='$postaddr',oname='$oname',oaddr='$oaddr',oarea='$oarea',ocity='$ocity',ocountry='$ocountry',ozipcode='$ozipcode',ophone='$ophone',ofax='$ofax',oemail='$oemail',ocp1_name='$ocp1_name',ocp1_title='$ocp1_title',ocp2_name='$ocp2_name',ocp2_title='$ocp2_title',onpwp='$onpwp',opkp='$opkp',oest_date='$oest_date',ovat='$ovat',hp='$hp',bus_fld='$bus_fld',bus_item='$bus_item' where id=$id";
