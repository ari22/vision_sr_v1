...
if (isset($func))
{
	...
	if ($func=='update')
	{
		...
		if (isset($field1) && isset($field2))
		{
			...
			{	
				...
				//mau dicoba versi sendiri
				$query_update="update $table set $field2='".strtoupper($$field2)."',part_alias='$part_alias',unit='$unit',qty='$qty',qty_pick='$qty_pick',qty_order='$qty_order',qty_border='$qty_border',sal_price='$sal_price',brand_code='$brand_code',mdin_code='$mdin_code',use4_code='$use4_code',input_date='$input_date',note='$note' where id=$id";
	...
	{	
		...
		$result = "select $defaultfields from $table where 1=1 and prt_inact='' ";
