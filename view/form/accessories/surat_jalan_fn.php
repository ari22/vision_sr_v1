<script>
    ...
    function print_sc(key) {
        ...
        if (stat !== false) {
            ...
            var ids = $("#id").val();
            var url = site_url + 'transaction/form/outputpdf/<?php echo encrypt_decrypt('encrypt', 'acc_slh'); ?>/' + ids + '/<?php echo $_SESSION['C_USER']; ?>/' + key + '/' + type + '/<?php echo encrypt_decrypt('encrypt', 'ADO'); ?>/'+date+'#toolbar=0';
