...
<div style=" margin: 10px;" id="form_content">
    <form id="<?php echo $form; ?>" >
        ...
        <div class="single-form">
            <table >
                 <tr><td colspan="3"> <h1 style="font-size:18px"><u>Accessories Outstanding Purchase Order Report</u></h1></td></tr>
                <?php
                localcombobox('cls', 'Cetak Faktur PO', 200, $close);
                datebox('date1', 'Tanggal PO', 200);
