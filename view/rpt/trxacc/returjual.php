...
<div style=" margin: 10px;" id="form_content">
    <form id="<?php echo $form; ?>" >
        ...
        <div class="single-form">
            <table >
                <tr><td colspan="3"> <h1 style="font-size:18px"><u>Accessories Sales Return Report </u></h1></td></tr>
                <?php
                localcombobox('cls', 'Retur Jual', 200, $close);
...
<script>
    ...
    function setEnable()
    {
        ...
        wrhs_code = $("#wrhs_code").combogrid('enable');
