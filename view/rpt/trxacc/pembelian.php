...
$optGroupBy = array
    ...
    array("Invoice No. & Supplier Invoice Date", "5"),
    array("Invoice Date & Supplier Invoice No.", "6"),
    array("Part Code", "3"),
    array("Supplier", "4"),
);
?>
...
<div style=" margin: 10px;" id="form_content">
    <form id="<?php echo $form; ?>" >
        ...
        <div class="single-form">
            <table>
                 <tr><td colspan="3"> <h1 style="font-size:18px"><u>Accessories Purchase Report </u></h1></td></tr>
                <?php
                localcombobox('cls', 'Pembelian', 200, $close);
                datebox('date1', 'Tanggal', 200);
                datebox('date2', 's/d1', 200);
                localcombobox('group_by', 'Group By', 300, $optGroupBy);
