                ...
                <tr>
                    ...
                    <td valign="top">
                        <table>
                            ...
                            ?>
                            <tr>
                                <td width="108"><?php getCaption('Chassis'); ?></td>
                                <td class="td-ro">:</td>
                                <td colspan="4">
                                    <table class='marginmin'>
                                        <tr>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <table class='marginmin'>
                                        <tr>
                                            <td><?php textbox2('veh_type', 120, 100); ?></td>
                                            <td align="right" width="80"><?php getCaption('Transmisi'); ?></td>
                                            <td class="td-ro">:</td>
                                            <td><?php textbox2('veh_transm', 50, 100); ?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <table class='marginmin'>
                                        <tr>
                                            <td><?php textbox2('veh_model', 120, 100); ?></td>
                                            <td align="right" width="80"><?php getCaption('Tahun'); ?></td>
                                            <td class="td-ro">:</td>
...
<script>
        ...
        if (state !== false) {
            ...
            if (lcOutput == 'process') {
               ...
               $('#dt_ard').datagrid('loadData', emptydata);
                ...
                //$.post(site_url + 'history/read/?sal_inv_no=' + sal_inv_no + '&opn_date1=' + newdate1 + '&opn_date2=' + newdate2, {table: '<?php echo encrypt_decrypt('encrypt', 'veh_arh'); ?>', nav: '', id: ''}, function (json) {
                $.post( url + '?lookup=rpt/history&inv_no=sal_inv_no&val_no=' + sal_inv_no + '&date1=' + newdate1 + '&date2=' + newdate2, {table1: 'veh_arh', table2: 'veh_ard'}, function (json) {  //alert(json)
                ...
                var URL = url + "?lookup=rpt/history/piutangkendaraan"
                        + "&output=" + lcOutput
    ...
    function table_grid(jsonRows) {
         $("#dt_ard").datagrid({
            ...
            //url:'services/runCRUD.php?func=listgrid&lookup=trx/veh_ard&pk=sal_inv_no&inv_no='+sal_inv_no,
            url:jsonRows,
            idField: 'id',
            fitColumns: false,
            singleSelect: true,
