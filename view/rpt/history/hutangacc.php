                ...
                <tr>
                    ...
                    <td valign="top">
                        <table>
                            ...
                            <tr><td width='120'></td></tr><tr><td></td></tr>
                        </table>
                        <table>
                            <?php
    ...
    function showSearch(lcOutput) {
        ...
        if (state !== false) {
            ...
            if (lcOutput == 'process') {
                ...
                $.post(url + '?lookup=rpt/history&inv_no=pur_inv_no&val_no=' + pur_inv_no + '&date1=' + newdate1 + '&date2=' + newdate2, {table1: 'acc_aph', table2: 'acc_apd'}, function (json) {
                ...
                var URL = url + "?lookup=rpt/history/hutangacc"
                        + "&output=" + lcOutput
