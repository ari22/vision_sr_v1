...
<div style=" margin: 10px;" id="form_content">
    <form id="<?php echo $form; ?>" >
        <div class="single-form">
            <table>
                <tr><td colspan="3"><h1><u>Vehicle Registration Report</u></h1></td></tr>
                ...
                <tr>	
                    ...
                    <td style="max-width: 5px !important;" class="td-ro">:</td>
                    <td>
                        <?php datebox2('stnk_rdate1'); ?> s/d <?php datebox2('stnk_rdate2'); ?>
                    </td>
                ...
                <tr>	
                    ...
                    <td style="max-width: 5px !important;" class="td-ro">:</td>
                    <td>
                        <?php datebox2('stnk_sdate1'); ?> s/d <?php datebox2('stnk_sdate2'); ?>
                    </td>
...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        $('#stnk_rdate1').datebox('setValue', date1);
        $('#stnk_rdate2').datebox('setValue', date2);
        $('#stnk_sdate1').datebox('setValue', date1);
        $('#stnk_sdate2').datebox('setValue', date2);
        setEnable();
        $(".loader").hide(1000);
        version('04.17-25');
    });
    ...
    function doSearch(lcOutput)
    {
        ...
        lcstnk_rdate1 = $('#stnk_rdate1').datebox('getValue');
        lcstnk_rdate2 = $('#stnk_rdate2').datebox('getValue');
        lcstnk_sdate1 = $('#stnk_sdate1').datebox('getValue');
        lcstnk_sdate2 = $('#stnk_sdate2').datebox('getValue');
