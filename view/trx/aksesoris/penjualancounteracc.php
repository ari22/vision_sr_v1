<?php
$key = searcharray('ASC', 'inv_type', $inv_seq);
        ...
        <div class="single-form teen-margin">
            <table>
                <tr>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table class='marginmin'>
                                        <tr>
                                            <td width="163"><table style="margin-left: -3px;"><?php  cmdprtWrhs('wrhs_code', ''); ?></table></td>
                    ...
                    <td  valign="top">
                        <table style="top: 1;">
                            <?php cmdAccCust('cust_code', 'cust_name', 'Pelanggan', 80, 250); ?>
                            <?php cmdAccSalesPerson('srep_code', 'srep_name', 'Sales', 80, 250); ?>
...
<div id="DetailWindow" class="easyui-window" title="Counter Accessories Sales" data-options="closable:true,minimizable:false,maximizable:false,collapsible:false,closed:true,modal:true,closed:true,inline:true" style="width:1060px;height:550px;padding:5px;top:1;">
...
<?php include 'penjualancounteracc_fn.php'; ?>