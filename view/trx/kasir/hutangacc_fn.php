<script>
    ...
    var save_url = site_url + 'transaction/cashier/save_acc_aph';
        ...
        $.post(site_url + 'crud/read', {table: table, nav: nav, id: id}, function (json) { //alert(json)
            ...
            if (json !== '[]') {
                ...
                $.each(rowData, function (i, v) {
                    ...
                    if (i == 'inv_bt' || i == 'inv_vat' || i == 'inv_stamp' || i == 'inv_total' || i == 'hd_begin' || i == 'hd_paid' || i == 'hd_disc' || i == 'hd_end') {
                        $("#" + i).numberbox('setValue', v);
                    }

                    if (i == 'pur_date' || i == 'opn_date' || i == 'due_date' || i == 'supp_invdt' || i == 'po_date' || i == 'so_date') {
                        if (v !== '0000-00-00') {
...
/*
    ...
    */
    ...
    function table_grid(ttable, pur_inv_no) {
        ...
        ttable.datagrid({
            method: 'post',
            url: site_url + '<?php echo 'builder/datagrid/' . encrypt_decrypt('encrypt', 'acc_apd'); ?>/pur_inv_no/' + pur_inv_no + '/?grid=true',
            idField: 'id',
            fitColumns: false,
            singleSelect: true,
            nowrap: true,
    ...
    function saveData2() {
        ...
        var save_url2 = site_url + 'transaction/cashier/save_acc_apd/' + pur_inv_no + '/<?php echo $session['C_USER']; ?>';
    ...
    function condDelete2() {
        ...
        $.messager.confirm('Warning', 'Are you sure delete selected data ?', function (r) {
            if (r) {
                ...
                var url = site_url + 'transaction/cashier/deleteAccApd';
