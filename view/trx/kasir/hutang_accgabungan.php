...
$trans = array
    (
    array('',''),
    array("Accessories Purchase", "APR"),
    array("Optinal Purchase", "APW"),
    array("BBN Registration", "APB")
);
?>
                    ...
                    <td valign='top' width="535" >
                        <table style="margin-top: 25px;">
                         ...
                         <tr>
                                <td colspan='2'>
                                    <table class='marginmin'>
                                       <?php localcombobox('pinv_code', 'Transaksi', 150, $trans); ?>
                                        <tr><td class='col100'></td></tr>
                                    </table>
                                 </td>
                            </tr>
                            <tr>
                                <td colspan='2' valign='top'>
                                    <table class='marginmin'>
                                        <tr>
                                            <td><?php getCaption("Dibayar ke"); ?></td>
                                            <td class="td-ro">:</td>
                                            <td> 
                                                <table class='marginmin'>
                                                    <?php cmdAccSupp('supp_code', 'supp_name', '', 100, 252); ?>
                                                </table>
                                            </td>
                                        </tr>
...
<div id="DetailWindow" class="easyui-window" title="Accessories Account Payable Group Payment" data-options="closable:true,minimizable:false,maximizable:false,collapsible:false,closed:true,modal:true,closed:true,inline:true" style="width:1120px;height:500px;padding:5px;top:1;">
        ...
        <form id="form_validation2" method="post" >
            ...
            <table>
                <tr>
                    ...
                    <td align="right"><?php getCaption("Hutang"); ?></td>
                    <td  align="right" width="50"><?php getCaption("Saldo Awal"); ?></td>
                    <td  align="right" width="50"><?php getCaption("Pembayaran"); ?></td>
                    <td align="right"><?php getCaption("Diskon"); ?></td>
                    <td align="right"><?php getCaption("Saldo Akhir"); ?></td>
                </tr>
                <tr>
                    <td><input class="easyui-combogrid" id="pur_inv_no" name="pur_inv_no" disabled="true" style="width:120px;"></input></td>
                    <td><?php datebox2('pur_date', 100);?></td>     
                    <td><?php  textbox2('supp_invno', 120, 100);?></td>
                    <td><?php datebox2('supp_invdt', 100);?></td>     
                ...
                <tr>
                    ...
                    <td  width="50"><?php getCaption("No. PO"); ?></td>
                ...
                <tr>
                    <td><?php textbox2('po_no', 120, 100);?></td>
                    <td><?php datebox2('po_date', 100);?></td>
                   <!-- <td><?php datebox2('apv_date', 100);?></td>-->

                    <td colspan="2"><?php textbox2('veh_name', 225, 205);?></td>
...
<?php include 'hutang_accgabungan_fn.php'; ?>
