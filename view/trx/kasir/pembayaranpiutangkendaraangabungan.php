...
<div style=" margin: 10px;" id="form_content">
    <form id="form_validation" method="post" >
                            ...
                            <tr>
                                <td valign='top'>
                                    <table class='marginmin'>
                                        <?php textbox('arg_inv_no', 'No. Faktur', 142, 150); ?>
                                ...
                                <td valign='top'>
                                    <table class='marginmin'>
                                         <?php datebox('arg_date', 'Tgl. Faktur'); ?>
                            ...
                            <tr>
                                <td colspan='2' valign='top'>
                                    <table class='marginmin'>
                                         ...
                                         <?php cmdCustSet('cust_code', 'cust_name', 'Pelanggan'); ?>
        ...
        <div class="single-form">
            <table id="dt_argd" class="easyui-datagrid"  title="" style="width:1080px;height:200px;"></table>
            <table>
                <tr>
        ...
        <div class="main-nav">
            <table width="100%">
                <tr>
                    <td width="300"><?php navigation_ci(); ?></td>
                    <td width="500">
                        <table border="0">
                            <tr>
...
<div id="DetailWindow" class="easyui-window" title="Account Receivable Group Payment" data-options="closable:true,minimizable:false,maximizable:false,collapsible:false,closed:true,modal:true,closed:true,inline:true" style="width:1084px;height:500px;padding:5px;top:1;">
    <div style=" margin: 20px;">
        <table id="dt_argd2" class="easyui-datagrid"  title="" style="width:1020px;height:200px;"></table>
        <br />
        <form id="form_validation2" method="post" >
            ...
            <table>
                <tr>
                    ...
                    <td  width="50"><?php getCaption("No. Faktur Jual"); ?></td>
                    <td><?php getCaption("No. SPK"); ?></td>
                    <td class='right'><?php getCaption("Piutang"); ?></td>
                    <td width="50" class='right'><?php getCaption("Saldo Awal"); ?></td>
                    <td width="50" class='right'><?php getCaption("Pembayaran"); ?></td>
                    <td class='right'><?php getCaption("Diskon"); ?></td>
                    <td class='right'><?php getCaption("Saldo Akhir"); ?></td>
                </tr>
                <tr>
                    <td><input class="easyui-combogrid" id="chassis" name="chassis" disabled="true" style="width:180px;"></input></td>
                    <td><?php textbox2('sal_inv_no', 110, 200); ?></td>
                    <td><?php textbox2('so_no', 100, 200); ?></td>
                    <td  width="50"><?php numberbox2('inv_total', 120, 17); ?></td>
                    <td><?php numberbox2('pd_begin', 120, 17); ?></td>
                    <td>
						<input class="easyui-numberbox" name="pd_paid" id="pd_paid" data-options="groupSeparator:','" style="width:120px;">
					<?php //numberbox2('pd_paid', 120, 17); ?>
					</td>
                    <td><?php numberbox2('pd_disc', 120, 17); ?></td>
                    <td><?php numberbox2('pd_end', 120, 17); ?></td>
                ...
                <tr>
                    ...
                    <td><?php datebox2('sal_date', 100); ?></td>
                    <td><?php datebox2('so_date', 100); ?></td>
...
<?php include 'pembayaranpiutangkendaraangabungan_fn.php'; ?>
