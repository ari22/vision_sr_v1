                    ...
                    <tr>
                        <td>
                            <table style="margin:0px 0cm 0cm 0cm; ">
                                <?php
                                numberbox('pur_base', 'Base Price', 150, 12);
                                numberbox('pur_opt', 'Optional Price', 150, 12);
                                ?>
                                <tr><td></td><td class="td-ro"></td><td style="text-align:right;"><hr /></td><td><b>+</b></td></tr>
                                <?php
                                numberbox('pur_bt', 'DPP', 150, 12);
                                numberbox('pur_vat', 'PPN', 150, 12);
                                ?>
                                <tr><td colspan="3"></td></tr>

                                <?php
                                numberbox('pur_pbm', 'PBM', 150, 70);
                                numberbox('pur_pph', 'PPH', 150, 70);
                                numberbox('pur_misc', 'Lain - Lain', 150, 70);
                                ?>
                                <tr><td></td><td class="td-ro"></td><td style="text-align:right;"><hr /></td><td><b>+</b></td></tr>
                                <?php
                                numberbox('pur_price', 'Harga Beli', 150, 12);
                                ?>
                                <tr><td width="100"></td></tr>
                            </table>
                        </td>
...
<?php include 'pembelian_dealer_fn.php'; ?>