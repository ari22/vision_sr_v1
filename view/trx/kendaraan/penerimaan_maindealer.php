                ...
                <table>
                    <tr>
                        <td valign="top">
                            ...
                            <table>
                                <tr><td></td><td></td><td> <h3>Vehicle</h3></td></tr>
                                <tr>
                                    <td>Supplier</td>
                                    <td>:</td>
                                    <td><input type="text" class="supp_name" style="width: 250px;"></td>
                                </tr>
                          
                                 <?php textbox('supp_npwp','NPWP', 200, 20);?>
                                 <?php textbox('supp_pkp', 'PKP', 200, 20);?>
                         ...
                         <td valign="top">
                             <h3>Optional</h3>
                             <table>
                                  <?php cmdSupp('supp2_code', 'supp2_name', '', 80, 250,1,1);?>
                                 <tr><td><?php textbox2('supp2_npwp', 200, 20);?></td></tr>
                                  <tr><td><?php textbox2('supp2_pkp', 200, 20);?></td></tr>
                             </table>
                         </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top">
                            <table>
                                ...
                                <tr>
                                    <td><?php getCaption('Debit Note'); ?></td>
                                    <td class="td-ro">:</td>
                                    <td><?php textbox2('dni2_no', 150, 100); ?></td>
