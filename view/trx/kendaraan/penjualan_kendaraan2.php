    ...
    <form id="form_validation" method="post" >
        ...
        <div class="easyui-tabs" id="tabscoi" >
                        ...
                        <td valign="top">
                               <table>
                                ...
                                <tr>
                                    ...
                                    <td width="220"><?php textbox2('veh_name', 290, 350); ?></td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="4" style='padding:0px !important'>
                                        <table class='marginmin'>
                                            <tr>                                               
                                                <td><?php textbox2('chassis', 180, 250); ?></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <table class='marginmin'>
                                            <tr>
                                                <td><?php textbox2('engine', 180, 250); ?></td>
                        ...
                        <td valign="top">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="td-ro">:</td>
                                    <td colspan="4">
                                        <?php textbox2('stdoptname', 380, 100); ?>
                                    </td>
                                </tr>
                                 <tr><td class="col100"></td></tr>
                            </table>
            ...
            <div title="<?php getCaption("Optional"); ?>" class="main-tab">
                ...
                <table id="dt_jasa" class="easyui-datagrid"  title="" style="width:1055px;height:200px;"></table>
                <br />
                <table style="margin-left: 710px;float:right;" >
                        ...
                        <table style="width:400px;" border="0">
                            <tr>
                                ...
                                <td  style="border-top:0px !important;">
                                    <a href="#" id="cmdOptional"  class="easyui-linkbutton"  onclick="cmdOptional()" disabled="true">Optional</a>
...
<div id="optionalWindow" class="easyui-window" title="<?php getCaption("Isi Perincian Pekerjaan/Jasa"); ?>" data-options="closable:true,minimizable:false,maximizable:false,collapsible:false,closed:true,modal:true,closed:true,inline:true" style="width:900px;height:500px;padding:10px;top:1;">

    <div style="width: 820; margin: 20px;">
        <table id="dt_jasa2" class="easyui-datagrid"  title="" style="width:800px;height:250px;"></table>
        <br />
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input data-options="precision:0,groupSeparator:'.',decimalSeparator:',',prefix:'Rp. '" class="easyui-numberbox" type="text" id="price_bd" name="price_bd" autocomplete="off"  style="width:100px;" disabled="true"></input></td>
                                <td><?php numberbox2('disc_pct', 80, 50); ?></td>
                                <td><input data-options="precision:0,groupSeparator:'.',decimalSeparator:',',prefix:'Rp. '" class="easyui-numberbox" type="text" id="disc_val" name="disc_val" autocomplete="off" style="width:100px;" disabled="true"></input></td>
                                <td><input data-options="precision:0,groupSeparator:'.',decimalSeparator:',',prefix:'Rp. '" class="easyui-numberbox" type="text" id="price_ad" name="price_ad" autocomplete="off" style="width:100px;" disabled="true"></input></td>                       
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table style="width:500px;" border="0">
                            <tr>
                                ...
                                <td  style="border-top:0px !important;">
                                    ...
                                    <button type="button" id="cmdDelete2" title="<?php getCaption("Hapus"); ?>" class="easyui-linkbutton" data-options="iconCls:'icon-no'" onclick="deletework()" disabled="true" > </button>
...
<div id="w" class="easyui-window" title="Silahkan Pilih Dari Stock Kendaraan" data-options="closable:false,minimizable:false,maximizable:false,collapsible:false,closed:false,modal:true,closed:true,inline:true" style="width:1050px;height:500px;padding:10px;top:1;"></div>
<div id="wUJ" class="easyui-window" title="Uang Jaminan  Kendaraan" data-options="closable:false,minimizable:false,maximizable:false,collapsible:false,closed:false,modal:true,closed:true,inline:true" style="width:900px;height:300px;padding:10px;top:1;">
    <table id="tableUJ"></table>
    <br />
    <span>Memo: Uang Jaminan di atas akan dimasukkan sekarang secara otomatis sebagai pelunasan ke Piutang Kendaraan</span>
    <br /><br />
...
<div id="printWindow" class="easyui-window" title="<?php getCaption("Cetak Faktur Penjualan Kendaraan"); ?>" data-options="closable:true,minimizable:false,maximizable:false,collapsible:false,closed:true,modal:true,closed:true,inline:true" style="width:780px;height:480px;padding:10px;top:1;">
            ...
            <tr>
                    ...
                    <table style="width: 93%;">
                        <tr><td>
                                <table style="background: #f4f4f4; padding:10px;border-radius:10px;margin-bottom: 10px; width: 100%">
                                    ...
                                    numberbox('inv_total', 'Harga Kendaraan', 150, 12);
                                    ?>
                                    <tr>
                                        <td width="230"></td><td colspan="2"></td>
                                    </tr>
                                </table>
                                <table style="background: #f4f4f4; padding:10px;border-radius:10px;margin-bottom: 10px;width: 100%">
                                    <?php
                                    numberbox('pay_val', 'Uang Jaminan', 150, 12);
                                    numberbox('used_val', 'U.J. yang Terpakai', 150, 12);
                                    numberbox('pay_total', 'SISA Uang Jaminan', 150, 12);
                                    ?>
                                    <tr><td colspan='3'd style="text-align:right;"><hr /></td></tr>
                                    <?php  numberbox('price_ad', 'SISA Tagihan U.J', 150, 12);?>
                       
                                     <tr>
                                        <td width="200"></td><td colspan="2"></td>
                                    </tr>
                                </table>
                                <table style="background: #f4f4f4; padding:10px;border-radius:10px;margin-bottom: 10px;width: 100%">
                                    <?php
                                    ...
                                    <tr><td colspan='3' style="text-align:right;"><hr /></td></tr>                                  
                                     <?php  numberbox('pd_end', 'Sisa Piutang', 150, 12);?>
                                    <tr>
                                        <td width="200"></td><td colspan="2"></td>
                                    </tr>
                                </table>
                ...
                <td>
                    ...
                    <table style="margin-top:0px;">
                        <tr>
                            <td><button type="button" id="screen" title="<?php getCaption("Screen Faktur"); ?>" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="rolesPrintScreen('screen');">Screen</button></td>
