                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <?php textarea('lease_addr', 'Alamat', 200); ?>
                        ...
                        <td>
                            ...
                            <table style="margin-top: 110px;margin-left: -100px;">
                                <tr><td colspan="3"><b><?php getCaption('Kelengkapan Dokumen'); ?></b></td></tr>
                    ...
                    <td valign="top">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                   <table width="100" class="checkboxBorder">
                                        <tr><td><a href="#" class="checkbox" name="srep_sex_1"><input type="radio" id="srep_sex_1" class="srep_sex_1"  name="srep" value="1"> <?php getCaption("Pria"); ?></a></td></tr>

                                        <tr><td><a href="#" class="checkbox" name="srep_sex_2"><input type="radio" id="srep_sex_2" class="srep_sex_2" name="srep" value="2"> <?php getCaption("Wanita"); ?></a></td></tr>

                                        <tr><td><a href="#" class="checkbox" name="srep_sex_3"><input type="radio" id="srep_sex_3" class="srep_sex_3" name="srep" value="3"> <?php getCaption("Perusahaan"); ?></a></td></tr>
                                   </table>
                                </td>
                            </tr>
