...
<div style=" margin: 10px;" id="form_content">
    <form id="<?php echo $form; ?>" >
        ...
        <h1 style="font-size:20px">Laporan Perhitungan Laba Rugi Bruto Penjualan Kendaraan</h1>
        ...
        <div  class="single-form" id="formactive">  
            <table>
                ...
                <?php //cmdCustSet('cust_code1', 'cust_name1', 'Dealer/Reseller', 80, 200,'cust_type=2');?>
