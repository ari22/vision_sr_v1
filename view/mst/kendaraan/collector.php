<div style="margin: 10px;" id="form_content">
    <form id="form_validation" method="post" action="">	
        ...
        <input type="hidden" name="table"  id="table" value="<?php echo 'veh_coll'; ?>">
        <div class="single-form">
            <table>
                <td valign="top" width="400">
                    <table>
                        <?php
                        textbox('coll_code', 'Kode Kolektor', 60, 3);
                        textbox('coll_name', 'Nama Kolektor', 200, 25);
                        textarea('haddr', 'Alamat', 200, 70);
                        phonebox('hphone', 'Telepon', 200);
                        cmdCity('hcity', 'Kota');
                        zipbox('hzipcode', 'Kode Pos', 80);
                        phonebox('hp', 'HP Pribadi', 200);
                        cmdLastEdu('highestedu', 'Pendidikan Tertinggi', 170);
                ...
                <td valign="top">
                    <table>
                        ...
                        cmdCollectorLevel('coll_lev', 'Level Kolektor');
...
<script type="text/javascript">
    ...
    var pk_name = '<?php getCaption("Kode Kolektor"); ?>';
    var sk_name = '<?php getCaption("Nama Kolektor"); ?>';
