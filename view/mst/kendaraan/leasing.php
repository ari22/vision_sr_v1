<div style="margin: 10px;" id="form_content">
    <form id="form_validation" method="post" action="">	
        ...
        <input type="hidden" name="table"  id="table" value="<?php echo 'lease'; ?>">
        ...
        <div class="single-form">
            <table>
                <td valign="top" width="400">
                    <table>
                        <?php
                        textbox('lease_code', 'Kode Bank', 90, 10);
                        textbox('lease_name', 'Nama Bank', 250, 25);
                        textarea('oaddr', 'Alamat', 200, 70);
                        cmdCity('ocity', 'Kota');
                        zipbox('ozipcode', 'Kode Pos', 60);
