<div style="margin: 10px;" id="form_content">
    <form id="form_validation" method="post" action="">	
        ...
        <input type="hidden" name="table"  id="table" value="<?php echo 'acc_prep'; ?>">
        <div class="single-form">
            <table>
                <td valign="top">
                    <table>
                        <?php
                        textbox('prep_code', 'Kode Purchaser', 60, 3);
                        textbox('prep_name', 'Nama Purchaser', 200, 25);
                ...
                <td valign="top">
                    <table style="margin-left:30px;" >
                        ...
                        cmdPurLev('prep_lev', 'Level Purchaser');
...
<div id="SearchOption" style="display:none;">  
    <form id="form_validation2" method="post" >    
        <div id="optionSPK" style="padding:10px;">
            <span><?php getCaption("Kode Purchaser"); ?>:</span>
            <input id="code" name="code">
            <span><?php getCaption("Nama Purchaser"); ?>:</span>
...
<script type="text/javascript">
    ...
    var pk_name = '<?php getCaption("Kode Purchaser"); ?>';
    var sk_name = '<?php getCaption("Nama Purchaser"); ?>';
        ...
        $.post(site_url + 'master/vehicle/read', {table: table, nav: nav, id: id}, function (json) { //alert(json)
            ...
            if (json !== '[]') {
                ...
                $('#form_validation').form('load', {
                    prep_code: rowData.prep_code,
                    prep_name: rowData.prep_name,
                    haddr: rowData.haddr,
