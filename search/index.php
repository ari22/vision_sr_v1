...
<div class="single-form" id="searchForm">
    <table width="100%">
        <tr>
            <td valign="top">
...
<script>
    ...
    function clickOK(){
            ...
            if(table_used == 'acc_slh'){
                  var cond = '<?php echo $_SESSION['cond']; ?>';
            ...
            $('#tableSearch').datagrid({
                ...
                columns: [[
                        <?php
                        $array = array('inv_total','pd_begin','pd_paid','pd_disc','pd_end','hd_begin','hd_paid','hd_disc','hd_end','tot_paid','veh_price','dp_end', 'total', 'qty','qty_order','qty_border','qty_pick','qty_border', 'pay_val', 'disc_val', 'dp_paid', 'dp_used');
