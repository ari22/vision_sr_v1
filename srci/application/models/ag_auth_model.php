...
class AG_Auth_model extends CI_Model
{
	...
	{
		if($this->db->set('tgl_daftar', date('Y-m-d'))->set('jam_daftar', date('h:i:s'))->set('username', $username)->set('password', $password)->set('email', $email)->set('id_grup', '0')->insert($this->user_table))
		{
			return TRUE;
		}
